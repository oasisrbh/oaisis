...
const rawAssets = [
  {
    ...
    images: [
      "/assets/rolex-daytona-panda.jpg",
      "/assets/rolex-daytona-panda-2.jpg",
      "/assets/rolex-daytona-panda-3.jpg",
      "/assets/rolex-daytona-panda-4.jpg",
      "/assets/rolex-daytona-panda-5.jpg",
    ],
    ...
    poolSize: 30000,
    // Offchain commitments reserved before launch (42% of the pool).
    // Shown as a separate, labeled segment — never mixed into the
    // onchain-raised figure, which always reflects the treasury balance.
    reservedUsd: 12600,
    status: "Live",
    chain: CHAIN,
    minEntry: 100,
