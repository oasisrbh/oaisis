...
// $OASIS presale deposit address on Robinhood Chain. Displayed so
// contributors can verify the official address before depositing ETH.
// Public onchain data; NEXT_PUBLIC_PRESALE_ADDRESS overrides per env.
export const PRESALE_ADDRESS =
  process.env.NEXT_PUBLIC_PRESALE_ADDRESS ||
  "0x47c95a20D91763177Db8Ad895eB4b7F5Ce544881";

// Explorer link for the presale address on the targeted chain.
export const presaleExplorerUrl = targetChain.blockExplorers?.default?.url
  ? `${targetChain.blockExplorers.default.url}/address/${PRESALE_ADDRESS}`
  : null;
